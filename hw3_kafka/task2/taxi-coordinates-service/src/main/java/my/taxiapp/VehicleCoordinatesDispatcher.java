...
@Service
public class VehicleCoordinatesDispatcher {
    private static final Logger LOGGER = LoggerFactory.getLogger(VehicleCoordinatesDispatcher.class);
    ...
    public void dispatchVehicleCoordinates(VehicleCoordinates vehicleCoordinates) {
